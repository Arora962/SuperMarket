...
void Smtp::sendMail_attach(const QString &from, const QString &to, const QString &subject, const QString &body, QStringList files)
{
    message = "To: " + to + "\n";
    message.append("From: " + from + "\n");
    message.append("Subject: " + subject + "\n");
...
void Smtp::readyRead()
{
    ...
    else if (state == User && responseLine == "334")
    {
        ...
        QString u = user;
        QByteArray ba = u.toLocal8Bit();
        const char *c_str2 = ba.data();
        *t << QByteArray().append(c_str2).toBase64()  << "\r\n";
        t->flush();
